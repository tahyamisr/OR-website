...
const offlineAccordionItems: AccordionItemData[] = [
    { title: '📝 1. التخطيط (Planning)', content: `<div dir="rtl"><p>القسم المتخصص في تخطيط وهيكلة الحدث وتقسيم أعضاء التنظيم ووضع اكثر من خطة لإدارة أي حدث.</p><h5 class="font-bold mt-4 mb-2 text-black">أدوات مساعدة:</h5><ul class="list-disc list-inside space-y-2"><li><b>خطة 5Ws:</b> لتحديد أساسيات الخطة (What/Why/Where/Who/When).</li><li><b>الخريطة الذهنية:</b> أداة لتنظيم الأفكار بطريقة مرنة وسهلة.</li><li><b>تحليل SWOT:</b> لتقييم نقاط القوة، والضعف، والفرص، والتهديدات.</li></ul></div>` },
    { title: '🚚 2. القسم اللوجيستي (Logistics)', content: '<div dir="rtl"><p>هو القسم المتخصص في امـــداد المعدات اللازمة للحدث من حيث: الصوت – الإضاءة – السماعات – الدروع والشهادات – المقاعد – الديكور.</p></div>' },
    { title: '🤝 3. الــتنســيـق (Co-ordination)', content: '<div dir="rtl"><p>هو القسم المتخصص في التنسيق بين اللجان وإدارة الأنشطة وتنسيق الفاعليات وعمل حركة وصل بين اللجان ومتابعة سير العمل حتي انتهاء الحدث.</p></div>' },
    { title: '📋 4. الــتســجيل (Registration)', content: `<div dir="rtl"><p>هو القسم المسؤول عن تجميع بيانات الحضور وتسجيلها قبل دخول الحدث.</p>
    ...
    <p class="mt-4"><b class="text-black">المهارات المطلوبة:</b> القدرة على رؤية الصورة الكبيرة، التكيف مع المواقف، العمل تحت ضغط، مهارات حل المشكلات، إدارة التوتر.</p></div>` },
    { title: '🤵 5. المراسم واستقبال كبار الشخصيات', content: `<div dir="rtl"><p>هو القسم المسؤول عن تنظيم المراسم الرسمية مع مراعاة التقاليد الاحترافية من حيث تحديد أماكن جلوسهم ثم استقبال الشخصيات المرموقة ومرافقتهم الى مكان الضيافة ثم مكان الحدث.</p>
    <div class="grid md:grid-cols-2 gap-x-8 gap-y-4 mt-4">
      ...
      <div>
        <h5 class="font-bold mb-2 text-black">كيفية الاستقبال:</h5>
        <ul class="list-disc list-inside space-y-2">
      ...
      <div>
        <h5 class="font-bold mb-2 text-black">أثناء الحدث:</h5>
        <ul class="list-disc list-inside space-y-2">
      ...
      <div>
        <h5 class="font-bold mb-2 text-black">نقاط مهمة في التواصل (الإتيكيت):</h5>
        <ul class="list-disc list-inside space-y-2">
    ...
    { title: '🎪 6. تنظيم موقع الحدث (Floor Team)', content: `<div dir="rtl"><h5 class="font-bold mb-2 text-black">قبل الايفنت (التنسيق قبل الحدث):</h5>
    <ul class="list-disc list-inside space-y-2">
    ...
    <h5 class="font-bold mt-4 mb-2 text-black">أثناء الايفنت (التنسيق أثناء الحدث):</h5>
    <ul class="list-disc list-inside space-y-2">
    ...
    <h5 class="font-bold mt-4 mb-2 text-black">بعد الايفنت (التنسيق بعد الحدث):</h5>
    <ul class="list-disc list-inside space-y-2">
      <li>✔️ تنظيم عملية الخروج.</li>
      <li>✔️ الحرص على عدم وجود أي تكدس أثناء الخروج.</li>
      <li>✔️ الحفاظ على نظافة المكان وسلامته.</li>
    </ul></div>` },
    { title: '🎭 7. فريق الكواليس (Backstage Team)', content: `<div dir="rtl"><p>الفريق المخصص لتحضير الترتيبات قبل واثناء الحدث مثل ( تجهيز الشهادات والدروع – مساعدة المتحدث – العروض التقديمية – التأكد من تجهيزات الصوت والضوء ).</p>
    ...
    <h5 class="font-bold mt-4 mb-2 text-black">في الأماكن المغلقة (Close Area):</h5>
    <ul class="list-disc list-inside space-y-2">
      <li>✅ سهولة السيطرة على المكان ويوفر خصوصية أعلى.</li>
      <li>🤝 إمكانية استخدامه في الاجتماعات التنظيمية الطارئة.</li>
    </ul>
     <h5 class="font-bold mt-4 mb-2 text-black">اعتبارات عامة:</h5>
    <ul class="list-disc list-inside space-y-2">
    ...
    { title: '🚑 8. فـريق الطوارئ والأزمــــــات (Emergency Team)', content: '<div dir="rtl"><p>هو الفريق المسؤول عن حل المشكلات والأزمات الطارئة خلال الحدث مثل النزاعات والمشاكل وتقديم الإسعافات الأولية.</p></div>' }
];

const onlineAccordionItems: AccordionItemData[] = [
    { title: '🧑‍💻 معلومات عنا ودور المنظمين', content: `<div dir="rtl"><p>هو نوع من أنواع التنظيم ولكن يتم علي نطاق الاونلاين فقط في خلال محاضرة أو فعالية اونلاين. يشمل دورهم الإشراف على تنفيذها، إدارة الحضور والتواصل مع المشاركين، وضمان أن تجري الأنشطة بسلاسة وفقًا للأهداف المحددة.</p>
    <h5 class="font-bold mt-4 mb-2 text-black">دور المنظمين اونلاين:</h5>
    <ul class="list-disc list-inside space-y-2">
    ...
    { title: 'Stages مراحل تنظيم المحاضرات عبر الإنترنت', content: `<div dir="rtl"><ul class="list-decimal list-inside space-y-4">
      <li><b class="font-semibold text-black">📢 البداية الأساسية:</b> يتم عمل جروب للتسويق للمحاضرة من حيث شير في كل مكان وشير بوست الفيسبوك من كافة اللجان لوجود عدد كبير في المحاضرة.</li>
      <li><b class="font-semibold text-black">1️⃣ المرحلة الأولى (الأعداد والتنفيذ):</b>
      ...
      <li><b class="font-semibold text-black">2️⃣ المرحلة الثانية (تنظيم المجموعة):</b> بعد اعداد الجروب تبدأ مهمة التواصل مع الجمهور:
         <ul class="list-disc list-inside space-y-2 mt-2 ml-4">
      ...
      <li><b class="font-semibold text-black">3️⃣ المرحلة الثالثة (تنظيم المحاضرة):</b>
        <ul class="list-disc list-inside space-y-2 mt-2 ml-4">
    ...
    { title: '🔗 التنسيق بين اللجان', content: `<div dir="rtl"><p>يتم التنسيق المستمر مع لجان الاتحاد المختلفة لضمان نجاح الفعالية الرقمية:</p>
...
const eventGoalsItems: AccordionItemData[] = [
    { 
        ...
        content: `<div dir="rtl"><ul class="space-y-3 text-base">
                        <li><b class="font-semibold text-black">📚 نقل المعلومات:</b> وسيلة لنقل المعرفة إلى الجمهور المستهدف.</li>
                        <li><b class="font-semibold text-black">🤝 تبادل الخبرات:</b> فرصة للمشاركين للتفاعل وتبادل الأفكار.</li>
                        <li><b class="font-semibold text-black">🌐 تعزيز التواصل:</b> بناء علاقات وشبكات جديدة وتوسيع دائرة المعارف.</li>
                        <li><b class="font-semibold text-black">📈 تعزيز العلامة التجارية:</b> الترويج للشركات وزيادة الوعي بالعلامة التجارية.</li>
                        <li><b class="font-semibold text-black">📢 التوعية:</b> زيادة الوعي بقضايا معينة أو الدعوة إلى العمل.</li>
                        <li><b class="font-semibold text-black">🏆 التكريم والاحتفال:</b> الاحتفاء بمناسبات خاصة أو تكريم أفراد على إنجازاتهم.</li>
                    </ul></div>` 
    },
    { 
        title: '✅ عوامل نجاح الفعاليات', 
        content: `<div dir="rtl"><ul class="space-y-3 text-base">
                        <li><b class="font-semibold text-black">🎯 التخطيط الجيد:</b> تحديد الأهداف، واختيار الجمهور، ووضع برنامج زمني.</li>
                        <li><b class="font-semibold text-black">📍 المكان المناسب:</b> اختيار مكان مناسب من حيث المساحة والتجهيزات.</li>
                        <li><b class="font-semibold text-black">✨ البرنامج الفعال:</b> تقديم برنامج مثير للاهتمام يلبي احتياجات الجمهور.</li>
                        <li><b class="font-semibold text-black">🎤 المتحدثون والخبراء:</b> اختيار متحدثين أكفاء لتقديم محتوى ذي قيمة.</li>
                        <li><b class="font-semibold text-black">🚀 التسويق والترويج:</b> جذب أكبر عدد من المشاركين.</li>
                        <li><b class="font-semibold text-black">📱 التواصل مع المشاركين:</b> التواصل المستمر مع الجمهور قبل وبعد الحدث.</li>
                    </ul></div>` 
    },
    { 
        title: '👁️ رؤيتنا', 
        content: `<div dir="rtl"><p class="text-base leading-relaxed">نسعى لتنظيم فعاليات استثنائية تترك بصمة إيجابية، وتساهم في تطوير مهارات الشباب وخلق فرص جديدة لهم، مع الالتزام بأعلى معايير الاحترافية والإبداع في كل خطوة.</p></div>` 
    }
];
            ...
            <Tabs defaultValue="offline" className="w-full">
                ...
                <TabsContent value="offline" className="mt-6">
                    <div className="card-custom rounded-xl p-4 md:p-6">
                         <h3 className="text-xl md:text-2xl font-bold mb-4 text-center text-black">أقسام التنظيم الميداني</h3>
                         <CustomAccordion items={offlineAccordionItems} />
                    </div>
                </TabsContent>
                <TabsContent value="online" className="mt-6">
                     <div className="card-custom rounded-xl p-4 md:p-6">
                        <h3 className="text-xl md:text-2xl font-bold mb-4 text-center text-black">أقسام التنظيم الرقمي</h3>
