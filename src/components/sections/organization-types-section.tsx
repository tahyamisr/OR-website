...
const onlineAccordionItems: AccordionItemData[] = [
    ...
    { title: 'Stages مراحل تنظيم المحاضرات عبر الإنترنت', content: `<div dir="rtl">
      <ul class="list-none space-y-4">
        <li>
          <b class="font-semibold text-black flex items-center">📢 البداية الأساسية:</b>
          <p class="mt-1 pr-4">يتم عمل جروب للتسويق للمحاضرة من حيث شير في كل مكان وشير بوست الفيسبوك من كافة اللجان لوجود عدد كبير في المحاضرة.</p>
        </li>
        <li>
          <b class="font-semibold text-black flex items-center">1️⃣ المرحلة الأولى (الأعداد والتنفيذ):</b>
        ...
        <li>
          <b class="font-semibold text-black flex items-center">2️⃣ المرحلة الثانية (تنظيم المجموعة):</b>
          <p class="mt-1 pr-4">بعد اعداد الجروب تبدأ مهمة التواصل مع الجمهور:</p>
          <ul class="list-disc list-inside space-y-2 mt-2 pr-4">
