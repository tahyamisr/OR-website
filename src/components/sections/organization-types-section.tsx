...
const offlineAccordionItems: AccordionItemData[] = [
    { title: '📝 1. التخطيط (Planning)', content: `<div dir="rtl"><p>القسم المتخصص في تخطيط وهيكلة الحدث وتقسيم أعضاء التنظيم ووضع اكثر من خطة لإدارة أي حدث.</p><h5 class="font-bold mt-4 mb-2 text-primary">أدوات مساعدة:</h5><ul class="list-disc list-inside space-y-2"><li><b>خطة 5Ws:</b> لتحديد أساسيات الخطة (What/Why/Where/Who/When).</li><li><b>الخريطة الذهنية:</b> أداة لتنظيم الأفكار بطريقة مرنة وسهلة.</li><li><b>تحليل SWOT:</b> لتقييم نقاط القوة، والضعف، والفرص، والتهديدات.</li></ul></div>` },
    ...
    <p class="mt-4"><b class="text-primary">المهارات المطلوبة:</b> القدرة على رؤية الصورة الكبيرة، التكيف مع المواقف، العمل تحت ضغط، مهارات حل المشكلات، إدارة التوتر.</p></div>` },
    ...
    { title: '🎪 6. تنظيم موقع الحدث (Floor Team)', content: `<div dir="rtl"><h5 class="font-bold mb-2 text-primary">قبل الايفنت (التنسيق قبل الحدث):</h5>
    <ul class="list-disc list-inside space-y-2">
