...
export default function LeadershipSection() {
    ...
    return (
        <section id="leadership" className="mb-16 scroll-mt-24">
            <h2 className="text-3xl font-bold mb-8 text-center">الهيكل التنظيمي للجنة المركزية</h2>
            ...
            <div className="grid grid-cols-1 gap-8">
                <div className="card-custom p-6 rounded-lg text-center">
                     ...
                     <p className="text-lg text-muted-foreground">رئيس اتحاد طلاب تحيا مصر</p>
                </div>
                 ...
                 <div className="card-custom p-6 rounded-lg col-span-full">
                    <div className="flex flex-col md:flex-row items-center gap-6">
                        ...
                        <div className="text-center md:text-right flex-1">
                             ...
                             <p className="text-lg text-muted-foreground mb-4">رئيس اللجنة المركزية للتنظيم</p>
                             <div className="flex justify-center md:justify-start gap-x-6 gap-y-2 flex-wrap mb-4">
                    ...
                    <div className="card-custom p-6 rounded-lg flex flex-col">
                        <div className="flex flex-col sm:flex-row items-center gap-4 mb-4">
                            ...
                            <div className="text-center sm:text-right">
                                <h3 className="text-xl font-bold">ريـــم مـنصــــور الــفقــي</h3>
                 ...
                 <div className="card-custom p-6 rounded-lg col-span-full">
                    <div className="flex flex-col items-center gap-4">
                        ...
                        <div className="text-center">
                            <h3 className="text-xl font-bold">حـنيـن اســلام مـبـــروك</h3>
